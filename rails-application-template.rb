...
#
# ~/searchapp/vendor/elasticsearch-0.20.6/bin/elasticsearch -p ~/searchapp/tmp/pids/elasticsearch.pid
...
puts
say_status "AddDDDDDDD   a javascript engine first too Gemfile\n", :yellow
puts        '-'*80, ''; sleep 1

gsub_file 'Gemfile', %r{# Gems used only for assets and not required}, <<-CODE
  gem 'therubyracer'
...
class Article < ActiveRecord::Base
  #Additional line added so that new articles can be created- may have been deleted in original
